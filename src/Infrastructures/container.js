...
const CommentLikeRepositoryPostgre = require('./repository/CommentLikeRepositoryPostgre');
const ReplyRepositoryPostgres = require('./repository/ReplyRepositoryPostgre');
...
container.register([
  ...
  },
  {
    ...
    Class: CommentLikeRepositoryPostgre,
    parameter: {
      dependencies: [
        {
          concrete: pool,
